...
const sections = [
  ...
  },
  {
    ...
    subtitle: "Beautiful flowering and landscaping plants for every garden.",
    images: [outdoor1, outdoor2, outdoor3, outdoor4],
  },
  {
    title: "Decorative Pottery",
    subtitle: "Designer pots and planters to complement every plant.",
    images: [pot1, pot2, pot3, pot4],
  },
  {
    title: "Fertilizers & Plant Care",
    subtitle: "Premium fertilizers and plant care products for healthy growth.",
    images: [fertilizer1, fertilizer2, fertilizer3, fertilizer4],
  },
  {
    title: "Plant Stands",
    subtitle: "Stylish wooden and metal stands for elegant plant display.",
  ...
  return (
    <>
      <PageHeader
        ...
        title={
          <>
            Explore our <em className="italic text-leaf font-normal">Collection</em>
          </>
        }
